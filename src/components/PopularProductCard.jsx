...
const PopularProductCard = ({imgURL, imgURL2, name, price}) => {
    ...
    <div className='flex flex-1 flex-col w-full max-sm:w-full border-solid border-[1px] border-gray-200'>
        ...
        <button class="text-red mt-2 hover:before:bg-redborder-red-500 relative h-[50px] w-full overflow-hidden border-t border-gray-200 bg-white px-3 text-black transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-customcolor before:transition-all before:duration-500 hover:text-white  hover:before:left-0 hover:before:w-full">
